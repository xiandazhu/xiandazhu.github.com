...
var Role = (function(_super){
    ...
    _proto.init = function(_type,_camp,_hp,_speed,_hitRadius,_heroType){
        ...
        if(!Role.cached){
            ...
            //缓存敌机3飞行动作
            Laya.Animation.createFrames(["war/enemy3_fly1.png","war/enemy3_fly2.png"]
            ,"enemy3_fly");
            //缓存敌机3爆炸动作
            Laya.Animation.createFrames(["war/enemy3_down1.png","war/enemy3_down2.png"
            ,"war/enemy3_down3.png","war/enemy3_down4.png","war/enemy3_down5.png","war/enemy3_down6.png"],"enemy3_down");
            //缓存敌机3碰撞动作
